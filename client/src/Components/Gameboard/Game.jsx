...
export default function Game(){
  ...
  if(cards.length === 0) {
    ...
    return (
      <div className={`flex flex-col h-full ${gameState.currentTeam === 'team_1' ? 'bg-primary' : 'bg-secondary'} cat `}>
        <div className="flex  flex-row justify-evenly mt-2 h-min">
          <GameLog />

          {gameState.stage === 'play' && (
          <div className="bg-transparent flex flex-col items-center h-min">
